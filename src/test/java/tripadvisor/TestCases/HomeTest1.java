...
public class HomeTest1 extends BaseTest {
	...
	public void TC01_DispalyTotalChargesForFourPeopels() throws IOException, InterruptedException {
		 ...
		 * "Total amount and charges per night for 1 st holiday homes---- " +
		 * firstRate); ExtentListeners.test.log(Status.INFO,
		 * "Total amount and charges per night for 2 nd holiday homes----" +
		 * secondRate); ExtentListeners.test.log(Status.INFO,
		 * "Total amount and charges per night for 3 rd holiday homes----" + thirdRate);
		 */}
	...
	public void TC02_ListSortWithTravelerRating() throws InterruptedException {
